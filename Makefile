...
live/tailwind:
	npx tailwindcss -i ./view/base.css -o ./view/static/css/styles.min.css --minify --watch

# run esbuild to generate the index.js bundle in watch mode.
live/esbuild:
	npx esbuild ./view/base.js --bundle --outdir=./view/static/js/ --watch
